<template>
  <div class="w-full text-white min-h-screen bg-blue-500">
    <div class="foo">
      <div
        class="bg-blue-500 absolute bottom-48 xl:right-72 transition-all duration-200 right-0 w-40 h-40 blur-3xl"
      ></div>
      ...
      <div
        class="m-auto animate-fade-in px-10 space-y-6 flex flex-col pt-48 items-start h-full w-full transition-width duration-200 xl:w-1/2"
      >
        <slot />
      </div>
    </div>
